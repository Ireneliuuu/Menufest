...
echo "=== 食材插入腳本 ==="
echo "用戶 ID: 716cc360-63dc-4880-a5c0-f84e9271d5e4"
echo ""
...
if curl -s -X POST http://localhost:8080/auth/login \
  ...
  -d '{"email": "moo@mail.com", "password": "00000000"}' > /tmp/login_response.json; then
...
if [ -z "$TOKEN" ] || [ "$TOKEN" = "null" ]; then
    ...
    echo ""
    echo "請檢查："
    echo "1. 用戶是否存在 (email: moo@mail.com)"
    echo "2. 密碼是否正確 (password: 00000000)"
    echo "3. 後端服務是否正常運行"
    exit 1
fi
...
declare -a ingredients=(
    ...
    "豆腐:2:個:2025-11-07"
    "橄欖:150:克:2025-11-08"
    "優格:500:毫升:2025-11-09"
    "味噌:200:克:2025-11-10"
    "鮭魚:400:克:2025-11-01"
    "九層塔:50:克:2025-11-02"
    "雞腿:4:個:2025-11-03"
    "泡菜:300:克:2025-11-04"
    "豬絞肉:300:克:2025-11-05"
    "檸檬:3:個:2025-11-01"
    "大腸:500:克:2025-11-02"
    # 新增 20 種
    "牛番茄:3:個:2025-11-01"
    ...
    "薑:50:克:2025-11-01"
    "蛤蜊:400:克:2025-11-08"
    "鮮奶:900:毫升:2025-11-01"
    "奶油:100:克:2025-11-01"
    "義大利麵:500:克:2026-03-01"
    "米:1000:克:2026-05-01"
    "豆漿:900:毫升:2025-11-08"
    "小黃瓜:3:條:2025-11-08"
    "菠菜:200:克:2025-11-08"
    "玉米:2:條:2025-11-01"
    "紅椒:1:個:2025-11-08"
    "可可粉:50:克:2026-01-08"
    "麵粉:1000:克:2026-04-15"
